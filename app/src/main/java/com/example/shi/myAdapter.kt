...
class myAdapter(private val products: ArrayList<dataAdapter>): RecyclerView.Adapter<myAdapter.myViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): myViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.one_item, parent, false)
